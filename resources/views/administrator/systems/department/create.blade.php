        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    {{ Form::open(array('action' => 'Administrators\Systems\DepartmentController@store', 'class' => 'm-form m-form--fit m-form--label-align-right')) }}
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group">
                                <label for="name">
                                    Tên
                                </label>
                                <input type="name" class="form-control m-input" id="name" placeholder="Tên phòng ban" name="name" value="{{ old('name') }}">
                            </div>
                            <div class="form-group m-form__group">
