                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group m-input-group m-input-group--square">
                                        ...
                                        <input type="text" class="form-control m-input" placeholder="" name="username" value="{{ $user['username'] }}">
                                    </div>
                                    <span class="m-form__help">
                                        Nhập username
                                    </span>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group m-input-group m-input-group--square">
                                        ...
                                        <input type="text" class="form-control m-input" placeholder="" name="phone" value="{{ $user['phone'] }}">
                                    </div>
                                    <span class="m-form__help">
                                        Nhập số điện thoại
                                    </span>
